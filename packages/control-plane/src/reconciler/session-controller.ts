...
import { assignmentNetworkMaterial, toGatePreparePlan } from "../planning/network-plan.js";
...
export async function beginRevocation(db: TransactionalQueryable): Promise<void> {
  await db.transaction(async (client) => {
